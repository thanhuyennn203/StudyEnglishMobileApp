...
//   const API_URL = 'http://192.168.1.7:5130/api/Level'; // đổi IP nếu dùng thiết bị thật
...
//                   onPress={() =>
//                     router.push(`'/(tabs)/(explore)?levelId=' + level.id`)
//                   }
//                 >
//                   {level.status === 'locked' && <Text style={styles.lockIcon}>🔒</Text>}
