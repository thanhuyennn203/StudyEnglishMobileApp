...
const API_URL = "http://10.0.2.2:5130/api/auth"; // Update to your backend URL/port if needed
...
type AuthContextType = {
  user: null | { id: string; email: string; displayName: string; avatarUrl?: string; CurrentLevel?: number; Role?: string };
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ user, tokens, login, logout, refresh, loading, setUser }}>
      {children}
